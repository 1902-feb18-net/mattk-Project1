...
namespace Project1.DataAccess.Migrations
{
    ...
    [Migration("20190310200434_InventoryDecimalIncreaseCustomerFullNameUnique")]
    partial class InventoryDecimalIncreaseCustomerFullNameUnique
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project1.DataAccess.DataClasses.Cupcake", b =>
                {
            ...
            modelBuilder.Entity("Project1.DataAccess.DataClasses.CupcakeOrder", b =>
                {
            ...
            modelBuilder.Entity("Project1.DataAccess.DataClasses.CupcakeOrderItem", b =>
                {
            ...
            modelBuilder.Entity("Project1.DataAccess.DataClasses.Customer", b =>
                {
                    b.Property<int>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Project1.DataAccess.DataClasses.Ingredient", b =>
                {
            ...
            modelBuilder.Entity("Project1.DataAccess.DataClasses.Location", b =>
                {
                    b.Property<int>("LocationId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Project1.DataAccess.DataClasses.LocationInventory", b =>
                {
            ...
            modelBuilder.Entity("Project1.DataAccess.DataClasses.RecipeItem", b =>
                {
            ...
            modelBuilder.Entity("Project1.DataAccess.DataClasses.CupcakeOrder", b =>
                {
                    b.HasOne("Project1.DataAccess.DataClasses.Customer", "Customer")
                        .WithMany("CupcakeOrder")
                        .HasForeignKey("CustomerId")
                        .HasConstraintName("FK_Order_Customer")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Project1.DataAccess.DataClasses.Location", "Location")
                        .WithMany("CupcakeOrder")
            ...
            modelBuilder.Entity("Project1.DataAccess.DataClasses.CupcakeOrderItem", b =>
                {
                    b.HasOne("Project1.DataAccess.DataClasses.Cupcake", "Cupcake")
                        .WithMany("CupcakeOrderItem")
                        .HasForeignKey("CupcakeId")
                        .HasConstraintName("FK_OrderItem_Cupcake")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Project1.DataAccess.DataClasses.CupcakeOrder", "Order")
                        .WithMany("CupcakeOrderItem")
            ...
            modelBuilder.Entity("Project1.DataAccess.DataClasses.Customer", b =>
                {
                    b.HasOne("Project1.DataAccess.DataClasses.Location", "DefaultLocationNavigation")
                        .WithMany("Customer")
            ...
            modelBuilder.Entity("Project1.DataAccess.DataClasses.LocationInventory", b =>
                {
                    b.HasOne("Project1.DataAccess.DataClasses.Ingredient", "Ingredient")
